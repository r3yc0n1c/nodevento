...
// TODO:
const sendCertMail = async (certData) => {
  try{
    // generated PDF file
    const pdfPath = path.resolve(__dirname, "..", "temp", `${certData.name}_${certData.event}${certData.year}_certificate.pdf`);
...
module.exports = { sendWelcomeMail, sendEventMail, sendCertMail };
